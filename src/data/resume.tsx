...
export const DATA = {
	...
	location: "New Taipei City, TWN",
	locationLink: "https://www.google.com/maps/place/taiwan",
	description:
		"A graduate student at National Taiwan University, majoring in biomedical bioinformatics. I'm passionate about software development.",
	summary:
		"I have experience in full stack development and machine learning. I've built several full stack web app using Modern frontend and backend technologies. I'm currently looking for a intern position in software engineering.",
	avatarUrl: "/me.jpg",
	skills: [
		"Node.js",
		"Express",
	...
	contact: {
		...
		social: {
			GitHub: {
				url: "https://github.com/ctchen1999",
				icon: Icons.github,
			},
			LinkedIn: {
				url: "https://www.linkedin.com/in/ctchen1999",
				icon: Icons.linkedin,
			},
			Resume: {
				url: "https://drive.google.com/drive/folders/1-BP5BEhdNZZvT3qL4x-laGMFGJIboVbj",
				icon: Icons.Resume,
			},
		},
	},
	work: [
		{
			company: "NTU BOSI Lab",
			badges: [],
			href: "https://bosi.csie.ntu.edu.tw/",
			location: "",
	...
	education: [
		{
			...
			degree: "Master's Degree of Biomedical informatics",
			logoUrl: "/NTU.png",
			start: "2021",
			end: "Present",
		},
		{
			...
			href: "https://www.ncu.edu.tw/tw/index.html",
	...
	projects: [
		{
			title: "CT-tour",
			href: "https://tour-website-mgqs.onrender.com/",
			dates: "Jan 2024 - Feb 2024",
			active: true,
			description:
				"Revolutionized traditional travel organization, enhancing family travel business experience by creating tour website platform.",
			technologies: [
				"Node.js",
				"Express",
				"MongoDB",
			...
			links: [
				{
					type: "Website",
					href: "hhttps://tour-website-mgqs.onrender.com/",
					icon: <Icons.globe className="size-3" />,
				},
				{
					type: "Source code",
					href: "https://github.com/ctchen1999/tour-website",
		...
		{
			title: "CT-store",
			href: "https://github.com/ctchen1999/CT-store",
			dates: "Mar 2024 - Apr 2024",
			active: true,
			description:
				"Implemented advanced front-end UI and conducted comprehensive auto testing using Jest, Cypress and CI tools.",
			technologies: ["Node.js", "Express", "MongoDB", "Jest", "Cypress"],
			links: [
				{
					type: "Source code",
					href: "https://github.com/ctchen1999/CT-store",
		...
		// 	href: "https://github.com/ctchen1999/React-practice",
